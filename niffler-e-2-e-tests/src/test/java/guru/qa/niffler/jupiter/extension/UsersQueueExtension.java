...
public class UsersQueueExtension implements BeforeEachCallback, AfterEachCallback, ParameterResolver {
    ...
    static {
        EMPTY_USERS.add(new StaticUser("test1", "test1", true));
        NOT_EMPTY_USERS.add(new StaticUser("test2", "test2", false));
        NOT_EMPTY_USERS.add(new StaticUser("test3", "test3", false));
    }
