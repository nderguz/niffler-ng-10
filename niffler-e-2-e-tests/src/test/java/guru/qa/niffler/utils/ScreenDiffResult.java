...
import guru.qa.niffler.jupiter.extension.ScreenShootExtension;
...
public class ScreenDiffResult implements BooleanSupplier {
    ...
    public boolean getAsBoolean() {
        if (hasDiff){
            ScreenShootExtension.setExpected(expected);
            ScreenShootExtension.setActual(actual);
            ScreenShootExtension.setDiff(diff.getMarkedImage());
        }
        return hasDiff;
    }
}
